const Finance = {
    ...
    updateSalary: function(val) {
        ...
        FinanceXP.addXP(25, "Set monthly salary");
        this.save();
        this.render();
    },
    ...
    addExpense: function() {
        ...
        FinanceXP.addXP(10, "Added transaction");
        this.save();
        this.render();
    },
...
const FinanceXP = {
    ...
    data: JSON.parse(localStorage.getItem("finance_xp")) || {
        xp: 0,
        level: 1,
        streak: 0,
        lastDate: null
    ...
    levelUp() {
        alert(`💰 Finance Level Up! Level ${this.data.level}`);
    },
    ...
    render() {
        ...
        document.getElementById("finance-xp-bar").style.width = percent + "%";
        document.getElementById("finance-xp-text").innerText = `${this.data.xp} / ${needed} XP`;
        document.getElementById("finance-level").innerText = `Level ${this.data.level}`;
        document.getElementById("finance-streak").innerText = `🔥 Streak ${this.data.streak}`;
    },

    save() {
        localStorage.setItem("finance_xp", JSON.stringify(this.data));
    }
};
